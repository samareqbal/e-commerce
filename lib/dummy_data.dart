...
import 'features/store/models/promo_code_model.dart';

class SDummyData {
  /// List of all Banners
  static final List<BannerModel> banner = [
    BannerModel(
        imageUrl: SImages.homeBanner1,
        targetScreen: SRoutes.order,
        active: true),
    BannerModel(
        imageUrl: SImages.homeBanner2,
        targetScreen: SRoutes.cart,
        active: true),
    BannerModel(
        imageUrl: SImages.homeBanner3,
        targetScreen: SRoutes.wishlist,
        active: true),
    BannerModel(
        imageUrl: SImages.homeBanner4,
        targetScreen: SRoutes.productDetail,
        active: true),
    BannerModel(
        imageUrl: SImages.homeBanner5,
        targetScreen: SRoutes.profile,
        active: true),
  ];
  ...
  static final List<CategoryModel> categories = [
    /// Parent Categories
    CategoryModel(
        id: '1', name: 'Clothes', image: SImages.clothesIcon, isFeatured: true),
    CategoryModel(
        id: '2', name: 'Shoes', image: SImages.shoesIcon, isFeatured: true),
    CategoryModel(
        id: '3',
        name: 'Cosmetics',
    ...
    CategoryModel(
        ...
        isFeatured: true),
    CategoryModel(
        id: '6', name: 'Sports', image: SImages.sportsIcon, isFeatured: true),

    /// Clothes
    CategoryModel(
        id: '7', name: 'Shirts', image: SImages.shirtIcon, parentId: '1'),
    CategoryModel(
        id: '8', name: 'Jackets', image: SImages.jacketsIcon, parentId: '1'),
    CategoryModel(
        id: '9', name: 'Shorts', image: SImages.shortsIcon, parentId: '1'),

    /// Shoes
    CategoryModel(
        id: '10',
        name: 'Formal Shoes',
        image: SImages.formalShoesIcon,
        parentId: '2'),
    CategoryModel(
        id: '11',
        name: 'Sports Shoes',
        image: SImages.sportsShoesIcon,
        parentId: '2'),

    /// Cosmetics
    CategoryModel(
        id: '12', name: 'Face', image: SImages.faceIcon, parentId: '3'),
    CategoryModel(
        id: '13', name: 'Hair Oils', image: SImages.hairOilIcon, parentId: '3'),
    CategoryModel(
        id: '14', name: 'Bags', image: SImages.bagsIcon, parentId: '3'),
    CategoryModel(
        id: '15', name: 'Perfumes', image: SImages.perfumeIcon, parentId: '3'),
    CategoryModel(
        id: '16', name: 'Watches', image: SImages.watchIcon, parentId: '3'),

    /// Electronics
    CategoryModel(
        id: '17',
        name: 'Gadgets',
        image: SImages.gadgetsIcon,
        parentId: '4',
        isFeatured: false),
    CategoryModel(
        id: '18',
    ...
    CategoryModel(
        id: '20',
        name: 'Bed',
        image: SImages.bedIcon,
        parentId: '5',
        isFeatured: false),
    CategoryModel(
        id: '21',
        name: 'Lamps',
        image: SImages.lampIcon,
        parentId: '5',
        isFeatured: false),
    ...
    CategoryModel(
        id: '22',
        name: 'Cricket',
        image: SImages.cricketIcon,
        parentId: '6',
        isFeatured: false),
    CategoryModel(
        id: '23',
        name: 'Soccer',
        image: SImages.soccerIcon,
        parentId: '6',
        isFeatured: false),
  ];
  ...
  static final List<BrandModel> brands = [
    BrandModel(
        id: '1',
        image: 'https://res.cloudinary.com/dxfhyjzf1/image/upload/v1758561752/Brands%20Images/niuismtrkodkmvsyoefx.png',
        name: 'Nike',
        productsCount: 2,
        isFeatured: true),
    BrandModel(
        id: '2',
        image: 'https://res.cloudinary.com/dxfhyjzf1/image/upload/v1758561753/Brands%20Images/enoiwgloye09fcwnvmja.jpg',
        name: 'Adidas',
        productsCount: 2,
        isFeatured: true),
    BrandModel(
        id: '3',
        image: 'https://res.cloudinary.com/dxfhyjzf1/image/upload/v1758561755/Brands%20Images/wgiw2anjju8pahn6yfta.jpg',
        name: 'Apple',
        productsCount: 8,
        isFeatured: true),
    BrandModel(
        id: '4',
        image: 'https://res.cloudinary.com/dxfhyjzf1/image/upload/v1758561756/Brands%20Images/pefmafq7re2cxpoth6wu.png',
        name: 'Bata',
        productsCount: 4,
        isFeatured: true),
    BrandModel(
        id: '5',
        image: 'https://res.cloudinary.com/dxfhyjzf1/image/upload/v1758561757/Brands%20Images/d06bafhtbslsx8gk9bwx.png',
        name: 'Bloody',
        productsCount: 9,
        isFeatured: false),
    BrandModel(
        id: '6',
        image: 'https://res.cloudinary.com/dxfhyjzf1/image/upload/v1758561759/Brands%20Images/pyfqisyxusp9tkiolget.jpg',
        name: 'Breakout',
        productsCount: 7,
        isFeatured: true),
    BrandModel(
        id: '7',
        image: 'https://res.cloudinary.com/dxfhyjzf1/image/upload/v1758561760/Brands%20Images/yzq3cvzr3di3y0yrhme5.png',
        name: 'Dari Mooch',
        productsCount: 4,
        isFeatured: true),
    BrandModel(
        id: '8',
        image: 'https://res.cloudinary.com/dxfhyjzf1/image/upload/v1758561762/Brands%20Images/kkwufpi4n61bkefjmffr.jpg',
        name: 'Interwood',
        productsCount: 9,
        isFeatured: false),
    BrandModel(
        id: '9',
        image: 'https://res.cloudinary.com/dxfhyjzf1/image/upload/v1758561763/Brands%20Images/hlh2op8lway46c7bchqj.jpg',
        name: 'HP',
        productsCount: 4,
        isFeatured: false),
    BrandModel(
        id: '10',
        image: 'https://res.cloudinary.com/dxfhyjzf1/image/upload/v1758561765/Brands%20Images/hn3b7ebrcuiuwbiv6bvc.png',
        name: 'J.',
        productsCount: 8,
        isFeatured: true),
    BrandModel(
        id: '11',
        image: 'https://res.cloudinary.com/dxfhyjzf1/image/upload/v1758561766/Brands%20Images/ehikldjjjosfte4vlacd.png',
        name: 'NDURE',
        productsCount: 4,
        isFeatured: true),
    BrandModel(
        id: '12',
        image: 'https://res.cloudinary.com/dxfhyjzf1/image/upload/v1758561768/Brands%20Images/bp8gjw79zgvg8e0c0w4y.jpg',
        name: 'NorthStar',
        productsCount: 2,
        isFeatured: true),
    BrandModel(
        id: '13',
        image: 'https://res.cloudinary.com/dxfhyjzf1/image/upload/v1758561769/Brands%20Images/lchsmkdghrqmayuyx96h.png',
        name: 'Polo',
        productsCount: 2,
        isFeatured: true),
  ];
  ...
  static final List<ProductModel> products = [
    ...
    ProductModel(
        ...
        price: 350,
        isFeatured: true,
        thumbnail: SImages.productImage4a,
        description:
        ...
        brand: brands[2],
        images: [
          SImages.productImage4b,
          SImages.productImage4c,
          SImages.productImage4d,
          SImages.productImage4e
        ],
        sku: 'ABR4568',
        categoryId: '19',
        productAttributes: [
    ...
    ProductModel(
        ...
        price: 60,
        isFeatured: false,
        thumbnail: SImages.productImage5,
        description:
    ...
    ProductModel(
      ...
      stock: 50,
      price: 55.99,
      thumbnail: SImages.productImage8,
      description:
    ...
    ProductModel(
      ...
      salePrice: 7.99,
      price: 8.99,
      thumbnail: SImages.productImage9,
      description:
    ...
    ProductModel(
        ...
        brand: brands[3],
        thumbnail: SImages.productImage10,
        description:
    ...
    ProductModel(
      ...
      thumbnail: SImages.productImage11,
      sku: 'BATA-SOCKS',
      categoryId: '9',
      isFeatured: true,
      brand: brands[3],
    ...
    ProductModel(
        ...
        stock: 10,
        price: 4.99,
        thumbnail: SImages.productImage12,
        description:
    ...
    ProductModel(
        ...
        price: 39.99,
        stock: 23,
        thumbnail: SImages.productImage13,
        description:
    ...
    ProductModel(
        ...
        stock: 3,
        salePrice: 87.99,
        thumbnail: SImages.productImage14,
        description:
    ...
    ProductModel(
        ...
        stock: 54,
        salePrice: 47.99,
        thumbnail: SImages.productImage15,
        description:
    ...
    ProductModel(
      ...
      price: 79.99,
      salePrice: 71.99,
      thumbnail: SImages.productImage16a,
      images: [SImages.productImage16b],
      stock: 153,
      description:
    ...
    ProductModel(
      ...
      stock: 19,
      brand: brands[5],
      thumbnail: SImages.productImage17,
      description:
    ...
    ProductModel(
      ...
      price: 59.99,
      salePrice: 49.99,
      thumbnail: SImages.productImage19a,
      images: [SImages.productImage19b],
      stock: 12,
      brand: brands[10],
      categoryId: '10',
      description:
    ...
    ProductModel(
      ...
      thumbnail: SImages.productImage20,
      price: 44.99,
      salePrice: 39.99,
      stock: 43,
      brand: brands[3],
    ...
    ProductModel(
        ...
        salePrice: 969.99,
        stock: 2,
        thumbnail: SImages.productImage22,
        brand: brands[8],
        categoryId: '18',
        productType: 'ProductType.variable',
        description:
    ...
    ProductModel(
      ...
      price: 29.99,
      salePrice: 26.99,
      thumbnail: SImages.productImage25,
      stock: 23,
      brand: brands[5],
      description:
    ...
    ProductModel(
      ...
      price: 49.99,
      salePrice: 44.99,
      thumbnail: SImages.productImage26,
      stock: 23,
      brand: brands[7],
      description:
    ...
    ProductModel(
        ...
        price: 12.99,
        thumbnail: SImages.productImage27,
        brand: brands[6],
        description:
    ...
    ProductModel(
      ...
      thumbnail: SImages.productImage29,
      stock: 3,
      price: 9.99,
      salePrice: 7.56,
      description:
    ...
    ProductModel(
        ...
        thumbnail: SImages.productImage30,
        stock: 3,
        price: 29.99,
        salePrice: 27.99,
        description:
    ...
    ProductModel(
        ...
        productAttributes: [
          ProductAttributeModel(
              name: 'Storage', values: ['64GB', '128GB', '512GB'])
        ],
        productVariations: [
          ProductVariationModel(
              id: '1',
              attributeValues: {'Storage': '64GB'},
              image: SImages.productImage32,
              stock: 3,
              price: 499.99,
              salePrice: 475.99,
    ...
    ProductModel(
        ...
        price: 849,
        thumbnail: SImages.productImage33a,
        images: [
          SImages.productImage33b,
          SImages.productImage33c,
          SImages.productImage33d
        ],
        description:
        ...
        productAttributes: [
          ProductAttributeModel(
              name: 'Storage', values: ['64GB', '128GB', '512GB']),
          ProductAttributeModel(
              name: 'Color', values: ['Green', 'Blue', 'Red', 'Black'])
        ],
        productVariations: [
          ProductVariationModel(
              id: '1',
              attributeValues: {'Storage': '64GB', 'Color': 'Green'},
              image: SImages.productImage33b,
              stock: 3,
              price: 849,
              salePrice: 799,
    ...
    ProductModel(
      ...
      thumbnail: SImages.productImage34,
      price: 1399.99,
      salePrice: 1268.99,
      stock: 76,
      description:
    ...
    ProductModel(
      ...
      thumbnail: SImages.productImage37,
      brand: brands[4],
      categoryId: '17',
      sku: "KEYBOARD-BLOODY",
    ),
    ...
    ProductModel(
        ...
        salePrice: 1133.99,
        stock: 34,
        thumbnail: SImages.productImage38a,
        images: [SImages.productImage38b, SImages.productImage38c],
        productType: 'ProductType.variable',
        categoryId: '18',
        sku: "LAPTOP-HP",
        brand: brands[8],
    ...
    ProductModel(
        ...
        thumbnail: SImages.productImage40,
        productType: 'ProductType.single',
        stock: 2,
        price: 399.99,
        salePrice: 375.99,
    ...
    ProductModel(
      ...
      price: 179.99,
      thumbnail: SImages.productImage42,
      stock: 23,
      brand: brands[4],
      description:
    ...
    ProductModel(
        ...
        thumbnail: SImages.productImage43,
        stock: 21,
        price: 479.99,
        salePrice: 452.99,
        productType: 'ProductType.single',
    ...
    ProductModel(
        id: '44',
        title:
            'StrikeBlade X7 – Ergonomic Wireless Gaming Mouse (Blue Edition)',
        thumbnail: SImages.productImage44,
        stock: 21,
        price: 49.99,
        productType: 'ProductType.single',
        categoryId: '17',
    ...
    ProductModel(
        ...
        thumbnail: SImages.productImage45a,
        images: [SImages.productImage45b],
        stock: 21,
        price: 29.99,
        salePrice: 28.99,
        productType: 'ProductType.variable',
    ...
    ProductModel(
      ...
      thumbnail: SImages.productImage46,
      stock: 21,
      price: 39.99,
      salePrice: 37.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
        ...
        thumbnail: SImages.productImage49a,
        images: [SImages.productImage49b],
        stock: 21,
        price: 89.99,
        salePrice: 84.99,
        productType: 'ProductType.variable',
    ...
    ProductModel(
      ...
      thumbnail: SImages.productImage50,
      stock: 21,
      price: 499.99,
      salePrice: 456.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: SImages.productImage51,
      stock: 21,
      price: 599.99,
      salePrice: 576.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: SImages.productImage53,
      stock: 21,
      price: 399.99,
      salePrice: 376.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: SImages.productImage55,
      stock: 2,
      price: 299.99,
      salePrice: 275.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: SImages.productImage56,
      stock: 2,
      price: 180,
      salePrice: 177,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: SImages.productImage57,
      stock: 2,
      price: 49,
      productType: 'ProductType.single',
      categoryId: '8',
    ...
    ProductModel(
      ...
      thumbnail: SImages.productImage58,
      stock: 2,
      price: 799.99,
      salePrice: 743.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: SImages.productImage59,
      stock: 2,
      price: 1299,
      salePrice: 743.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: SImages.productImage61,
      stock: 2,
      price: 129,
      salePrice: 127,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: SImages.productImage62,
      stock: 2,
      price: 259,
      productType: 'ProductType.single',
      categoryId: '21',
    ...
    ProductModel(
      ...
      thumbnail: SImages.productImage63,
      stock: 2,
      price: 249,
      salePrice: 212,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: SImages.productImage65,
      stock: 2,
      price: 620,
      salePrice: 615,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: SImages.productImage66,
      stock: 2,
      price: 15,
      productType: 'ProductType.single',
      categoryId: '8',
    ...
    ProductModel(
        ...
        thumbnail: SImages.productImage67a,
        images: [SImages.productImage67b, SImages.productImage67c],
        stock: 2,
        price: 8,
        productType: 'ProductType.variable',
        categoryId: '7',
    ...
    ProductModel(
      ...
      thumbnail: SImages.productImage68,
      stock: 2,
      price: 27,
      productType: 'ProductType.single',
      categoryId: '9',
  ...
  static final List<PromoCodeModel> promoCodes = [
    ...
    PromoCodeModel(
      id: '2',
      code: 'FLAT50',
      name: 'Flat ${STexts.currency}50 Off',
      discount: 50,
    ...
    PromoCodeModel(
      id: '6',
      code: 'BIGSAVE100',
      name: 'Big Save ${STexts.currency}100 Off',
      discount: 100,
      discountType: DiscountType.fixed,
      startDate: DateTime.now(),
    ...
    PromoCodeModel(
      id: '9',
      code: 'DIWALI500',
      name: 'Diwali Mega ${STexts.currency}500 Off',
      discount: 500,
      discountType: DiscountType.fixed,
      startDate: DateTime.now(),
    ...
    PromoCodeModel(
      id: '10',
      code: 'SAVE70',
      name: 'Save ${STexts.currency}70 Instantly',
      discount: 70,
      discountType: DiscountType.fixed,
